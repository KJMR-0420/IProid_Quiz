...
public class Lesson4_levels extends AppCompatActivity implements View.OnClickListener{
    ...
    int Lesson4Lvl1,Lesson4Lvl2,Lesson4Lvl3,Lesson4Lvl4,Lesson4Lvl5,
            Lesson4Lvl6,Lesson4Lvl7,Lesson4Lvl8,Lesson4Lvl9,Lesson4Lvl10;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lesson4_levels);
    ...
    public void onClick(View v) {
        if (CategoryValue.equals("LESSON4")){
            ...
            switch (v.getId()){
                ...
                case R.id.Level1:
                    ...
                    Intent intentLesson4Level1 = new Intent(Lesson4_levels.this,QuizActivity.class);
                    intentLesson4Level1.putExtra("Category",Question.CATEGORY_LESSON3);
                    intentLesson4Level1.putExtra("Level",1);
                    startActivity(intentLesson4Level1);
                    finish();
                    break;

                case R.id.Level2:

                    Intent intentLesson4Level2 = new Intent(Lesson4_levels.this,QuizActivity.class);
                    intentLesson4Level2.putExtra("Category",Question.CATEGORY_LESSON3);
                    intentLesson4Level2.putExtra("Level",2);
                    startActivity(intentLesson4Level2);
                    finish();
                    break;

                case R.id.Level3:

                    Intent intentLesson4Level3 = new Intent(Lesson4_levels.this,QuizActivity.class);
                    intentLesson4Level3.putExtra("Category",Question.CATEGORY_LESSON3);
                    intentLesson4Level3.putExtra("Level",3);
                    startActivity(intentLesson4Level3);
                    finish();
                    break;
                ...
                case R.id.Level4:
                    ...
                    Intent intentLesson4Level4 = new Intent(Lesson4_levels.this,QuizActivity.class);
                    intentLesson4Level4.putExtra("Category",Question.CATEGORY_LESSON3);
                    intentLesson4Level4.putExtra("Level",4);
                    startActivity(intentLesson4Level4);
                    finish();
                    break;
                ...
                case R.id.Level5:
                    ...
                    Intent intentLesson4Level5 = new Intent(Lesson4_levels.this,QuizActivity.class);
                    intentLesson4Level5.putExtra("Category",Question.CATEGORY_LESSON3);
                    intentLesson4Level5.putExtra("Level",5);
                    startActivity(intentLesson4Level5);
                    finish();
                    break;
                ...
                case R.id.Level6:
                    ...
                    Intent intentLesson4Level6 = new Intent(Lesson4_levels.this,QuizActivity.class);
                    intentLesson4Level6.putExtra("Category",Question.CATEGORY_LESSON3);
                    intentLesson4Level6.putExtra("Level",6);
                    startActivity(intentLesson4Level6);
                    finish();
                    break;
                case R.id.Level7:

                    Intent intentLesson4Level7 = new Intent(Lesson4_levels.this,QuizActivity.class);
                    intentLesson4Level7.putExtra("Category",Question.CATEGORY_LESSON3);
                    intentLesson4Level7.putExtra("Level",7);
                    startActivity(intentLesson4Level7);
                    finish();
                    break;

                case R.id.Level8:

                    Intent intentLesson4Level8 = new Intent(Lesson4_levels.this,QuizActivity.class);
                    intentLesson4Level8.putExtra("Category",Question.CATEGORY_LESSON3);
                    intentLesson4Level8.putExtra("Level",8);
                    startActivity(intentLesson4Level8);
                    finish();
                    break;

                case R.id.Level9:

                    Intent intentLesson4Level9 = new Intent(Lesson4_levels.this,QuizActivity.class);
                    intentLesson4Level9.putExtra("Category",Question.CATEGORY_LESSON3);
                    intentLesson4Level9.putExtra("Level",9);
                    startActivity(intentLesson4Level9);
                    finish();
                    break;
                case R.id.Level10:

                    Intent intentLesson4Level10 = new Intent(Lesson4_levels.this,QuizActivity.class);
                    intentLesson4Level10.putExtra("Category",Question.CATEGORY_LESSON3);
                    intentLesson4Level10.putExtra("Level",10);
                    startActivity(intentLesson4Level10);
                    finish();
                    break;
            }
    ...
    private void lockAndUnlockLevel(){
        ...
        Lesson4Lvl1 = sharedPreferences.getInt(Constants.KEY_LESSON4_LEVEL_1,0);
        Lesson4Lvl2  = sharedPreferences.getInt(Constants.KEY_LESSON4_LEVEL_2,0);
        Lesson4Lvl3  = sharedPreferences.getInt(Constants.KEY_LESSON4_LEVEL_3,0);
        Lesson4Lvl4  = sharedPreferences.getInt(Constants.KEY_LESSON4_LEVEL_4,0);
        Lesson4Lvl5  = sharedPreferences.getInt(Constants.KEY_LESSON4_LEVEL_5,0);
        Lesson4Lvl6  = sharedPreferences.getInt(Constants.KEY_LESSON4_LEVEL_6,0);
        Lesson4Lvl8  = sharedPreferences.getInt(Constants.KEY_LESSON4_LEVEL_8,0);
        Lesson4Lvl7  = sharedPreferences.getInt(Constants.KEY_LESSON4_LEVEL_7,0);
        Lesson4Lvl9  = sharedPreferences.getInt(Constants.KEY_LESSON4_LEVEL_9,0);
        Lesson4Lvl10  = sharedPreferences.getInt(Constants.KEY_LESSON4_LEVEL_10,0);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Lesson4_levels.this,Lessons.class);
